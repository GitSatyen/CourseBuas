...
-->
Trying to make the jumping physics work where I have been stuck on.
## Do
...
-->
Got advice on how I should call the jumping function using the states we made. Still figuring out how to make the states call to make things work smoothly. 
## Check
...
-->
Figured out how to make the jump work with the states. But not still stuck on the gravity to make the player go into the falling state.
## Act
